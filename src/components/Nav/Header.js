              ...
              <div className="rd-navbar-brand">
                ...
                <a className="brand" href="index.html">
                  <img
                    ...
                    src="images/logo-default-4-272x170.png"
                    alt
                    width={136}
                    height={85}
                  />
                  <img
                    ...
                    src="images/logo-inverse-4-272x170.png"
                    alt
                    width={136}
                    height={85}
                  />
                  <img
                    ...
                    src="images/logo-default-4-336x80.png"
                    alt
                    width={168}
                    height={40}
                  />
                      ...
                      <div className="unit unit-spacing-sm align-items-center">
                        ...
                        <div className="unit-body">
                          <h6 className="cart-inline-name">
                            <a href="single-product.html">2010 Pinot Grigio</a>
                          </h6>
                          <div>
                        ...
                        <div className="unit-body">
                          ...
                          <div>
                            <div className="group-xs group-middle">
                              ...
                              <h6 className="cart-inline-title">$1100.00</h6>
                            </div>
                          </div>
                        </div>
                      </div>
